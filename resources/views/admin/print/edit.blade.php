    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('print.index')}}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
    ...
    <form action="" method="post" id="printEditForm" name="printEditForm">
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$pictureMedias->title}} "  name="title" id="title" class="form-control" placeholder="Title">
                                        <p class="error"></p>
                                    </div>
                                </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <img src="{{ asset('uploads/pictureMedia/'.$pictureMedias->image)}}" alt="Product Image" width="50">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="status" id="status" class="form-control">
                                    <option value="1" {{($pictureMedias->status == 1) ? 'checked' : ''}}>Active</option>
                                    <option value="0"{{($pictureMedias->status == 0) ? 'checked' : ''}}>Block</option>
                                </select>
                            </div>
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{route('print.index')}}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </div>
    </form>
    <!-- /.card -->
...
@section('customJs')
<script>
    	$("#printEditForm").submit(function(e) {
		e.preventDefault();
		$("button[type=submit]").prop('disable',true);

		$.ajax({
			url: "{{route('print.update',$pictureMedias->id)}}",
			type: "POST",
			...
			success: function(response) {
				...
				if (response['status'] == true) {
					...
					window.location.href="{{route('print.index')}}";
