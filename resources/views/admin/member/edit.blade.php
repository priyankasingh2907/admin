...
<section class="content">
    <!-- Default box -->
    <form action="" method="post" id="memberEditForm" name="memberEditForm">
                ...
                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$members->name}} "  name="name" id="name" class="form-control" placeholder="Title">
                                        <p class="error"></p>
                                    </div>
                                </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <img src="{{ asset('uploads/members/'.$members->image)}}" alt="Product Image" width="50">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="status" id="status" class="form-control">
                                    <option value="1" {{($members->status == 1) ? 'checked' : ''}}>Active</option>
                                    <option value="0"{{($members->status == 0) ? 'checked' : ''}}>Block</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="fstatus" id="status" class="form-control">
                                    <option value="no" @if(($members->Feature)==0) 'selected'  @endif>No</option>
                                    <option value="yes" @if(($members->Feature)==1) 'selected'  @endif>Yes</option>
                                </select>
                                <p class="error"></p>
                            </div>
                        </div>
...
<script>
		...
		$.ajax({
			url: "{{route('member.update',$members->id)}}",
			type: "POST",
