                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$contact->title}} "  name="title" id="title" class="form-control" placeholder="Title">
                                        <p class="error"></p>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="address" id="address" cols="30" rows="10" class="summernote" placeholder="address">
                                            {{$contact->address}}
                                        </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" value="{{$contact->phone}} "  name="phone" id="phone" class="form-control" placeholder="phone">
                                        <p class="error"></p>
                                    </div>
                                </div> <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="email">email</label>
                                        <input type="email" value="{{$contact->email}} "  name="email" id="email" class="form-control" placeholder="email">
                                        <p class="error"></p>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="Feature" id="Feature" class="form-control">
                                    <option value=0 @if(($contact->Feature)=='0') 'selected'  @endif>No</option>
                                    <option value=1 @if(($contact->Feature)=='1') 'selected'  @endif>Yes</option>
                                </select>
                                <p class="error"></p>
                            </div>
                        </div>
