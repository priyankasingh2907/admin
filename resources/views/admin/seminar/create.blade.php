...
<section class="content">
    <!-- Default box -->
    <form action="" method="post" id="seminarForm" name="seminarForm">
        <div class="container-fluid">
            ...
            <div class="pb-5 pt-3">
                ...
                @if(!empty($brands))
                <a href="{{route('seminar.create')}}" class="btn btn-outline-dark ml-3">Cancel</a>
                @endif
            </div>
        </div>
    </form>
