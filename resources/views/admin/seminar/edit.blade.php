    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('seminar.index')}}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
...
<section class="content">
    <!-- Default box -->
    <form action="" method="post" id="seminarEditForm" name="seminarEditForm">
                ...
                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$seminars->title}} "  name="title" id="title" class="form-control" placeholder="Title">
                                        <p class="error"></p>
                                    </div>
                                </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <img src="{{ asset('uploads/seminars/'.$seminars->image)}}" alt="Product Image" width="50">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="status" id="status" class="form-control">
                                    <option value="1" {{($seminars->status == 1) ? 'checked' : ''}}>Active</option>
                                    <option value="0"{{($seminars->status == 0) ? 'checked' : ''}}>Block</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<script>
    	...
    	$("#seminarEditForm").submit(function(e) {
		e.preventDefault();
		...
		$.ajax({
			...
			success: function(response) {
				...
				if (response['status'] == true) {
					...
					window.location.href="{{route('seminar.index')}}";
