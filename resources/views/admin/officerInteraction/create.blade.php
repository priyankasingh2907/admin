...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Create officerInteraction</h1>
            </div>
...
<section class="content">
    <!-- Default box -->
    <form action="" method="post" id="officerInteractionForm" name="officerInteractionForm">
...
<script>
    ...
    $("#officerInteractionForm").submit(function(e) {
		e.preventDefault();
		$("button[type=submit]").prop('disable',true);

		$.ajax({
			url: "{{route('officerInteraction.store')}}",
			type: "POST",
