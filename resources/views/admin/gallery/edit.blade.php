...
<section class="content">
    <!-- Default box -->
    <form action="" method="post" id="galleryEditForm" name="productEditForm">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$galleries->title}} "  name="title" id="title" class="form-control" placeholder="Title">
                                        <p class="error"></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <img src="{{ asset('uploads/galleries/'.$galleries->image)}}" alt="Product Image" width="50">
                ...
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            <h2 class="h4 mb-3">Gallery status</h2>
                            <div class="mb-3">
                                <select name="status" id="status" class="form-control">
                                    <option value="1" {{($galleries->status == 1) ? 'checked' : ''}}>Active</option>
                                    <option value="0"{{($galleries->status == 0) ? 'checked' : ''}}>Block</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="fstatus" id="status" class="form-control">
                                    <option value="no" @if(($galleries->Featured)==0) 'selected'  @endif>No</option>
                                    <option value="yes" @if(($galleries->Featured)==1) 'selected'  @endif>Yes</option>
                                </select>
                                <p class="error"></p>
                            </div>
                        </div>
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{route('gallery.index')}}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </div>
    </form>
    <!-- /.card -->
