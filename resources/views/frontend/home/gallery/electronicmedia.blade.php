...
<div class="container">
  ...
  <div id="image-gallery">
    <div class="row align-items-center justify-content-center">
      ...
      @if(!empty($electronicmedia))
      @foreach($electronicmedia as $media )
      <div class="col-lg-3 m-4 card col-md-6 col-sm-6 col-xs-12 faculty_grid">
        <div class="img-wrapper border rounded">
          <a href="">

            <img src="{{ asset('uploads/electronicmedia/'.$media->image)}}" alt="{{$media->title}}" class=" text-center">
        ...
        <h6 class="m-3 text-center">{{$media->title}}</h6>
      </div>
