...
<div class="container">
  ...
  <h4 class="w3_agile_header mt-3 px-4">SEMINARs BY ( NHRCCB )</h4>
  <hr>
  ...
  <div id="image-gallery">
    <div class="row align-items-center justify-content-center">
      ...
      @if(!empty($seminar))
      @foreach($seminar as $act )
      <div class="col-lg-3  col-md-6 col-sm-6 col-xs-12 p-0 faculty_grid border rounded shadow">
        <div class="img-wrapper m-0 p-2 ">
          <a href="/">
     
            <img src="{{ asset('uploads/seminars/'.$act->image)}}" alt="{{$act->title}}" class="rounded text-center">
  ...
  <div class="bottom_content mb-5">
    <h4 class="w3_agile_header px-5 mt-3">OUR AWARDEEs</h4>
    <hr>
    <div class="section-top-border">
      <div class="row">
      @if(!empty($awards))
      @foreach($awards as $act )
