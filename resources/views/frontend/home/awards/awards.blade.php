...
<div class="container">
  ...
  <h4 class="w3_agile_header mt-3 px-4">AWARDS SENT BY ( NHRCCB )</h4>
  <hr>
      ...
      <div class="col-lg-3 m-4 card col-md-6 col-sm-6 col-xs-12 faculty_grid">
        <div class="img-wrapper border rounded">
          <a href="">
            ...
            <img src="{{ asset('uploads/awards/'.$act->image)}}" alt="{{$act->title}}" class=" text-center">
        ...
        <h6 class="m-3 text-center">{{$act->title}}</h6>
      </div>
